...
use crate::types::AccountsInfoWrapper;

#[derive(Properties, Clone, PartialEq)]
pub struct Props {
    pub search_user: AccountsInfoWrapper,
    pub callback: Callback<AccountsInfoWrapper>,
}

#[function_component(SearchUserComponent)]
pub fn search_user_component(props: &Props) -> Html {
    ...
    let on_search_input = {
        ...
        Callback::from(move |e: InputEvent| {
            ...
            let filtered_users: AccountsInfoWrapper = AccountsInfoWrapper {
                accounts: users
                    .accounts
                    .iter()
                    .filter(|admin| {
